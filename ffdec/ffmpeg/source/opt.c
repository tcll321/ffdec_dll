...
//
//    switch(o->type){
//    case FF_OPT_TYPE_FLAGS:     snprintf__(buf, buf_len, "0x%08X",*(int    *)dst);break;
//    case FF_OPT_TYPE_INT:       snprintf__(buf, buf_len, "%d" , *(int    *)dst);break;
//    case FF_OPT_TYPE_INT64:     snprintf__(buf, buf_len, "%"PRId64, *(int64_t*)dst);break;
//    case FF_OPT_TYPE_FLOAT:     snprintf__(buf, buf_len, "%f" , *(float  *)dst);break;
//    case FF_OPT_TYPE_DOUBLE:    snprintf__(buf, buf_len, "%f" , *(double *)dst);break;
//    case FF_OPT_TYPE_RATIONAL:  snprintf__(buf, buf_len, "%d/%d", ((AVRational*)dst)->num, ((AVRational*)dst)->den);break;
//    case FF_OPT_TYPE_STRING:    return *(void**)dst;
//    case FF_OPT_TYPE_BINARY:
//        len = *(int*)(((uint8_t *)dst) + sizeof(uint8_t *));
//        if(len >= (buf_len + 1)/2) return NULL;
//        bin = *(uint8_t**)dst;
//        for(i = 0; i < len; i++) snprintf__(buf + i*2, 3, "%02X", bin[i]);
//        break;
//    default: return NULL;
//    }
//    return buf;
