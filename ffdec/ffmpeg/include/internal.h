...
#ifndef HAVE_LLRINT
static av_always_inline av_const int64_t llrint(double x)
{
    return rint(x);
}
#endif /* HAVE_LLRINT */
...
#ifndef HAVE_LRINT
static av_always_inline av_const int64_t lrint(double x)
{
    return rint(x);
}
#endif /* HAVE_LRINT */
...
#ifndef HAVE_LRINTF
static av_always_inline av_const int64_t lrintf(float x)
{
    return (int)(rint(x));
}
#endif /* HAVE_LRINTF */
